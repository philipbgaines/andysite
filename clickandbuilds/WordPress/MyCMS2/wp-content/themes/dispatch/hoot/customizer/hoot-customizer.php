			...
			if ( is_array( $new_options ) ) {
				foreach ( $new_options as $key => $value ) {
					if ( isset( $this->options['settings'][$key] ) )
						...
						if ( $merge == 'replace' || $merge == 'recursive' )
							$this->options['settings'][$key] = array_replace_recursive( $this->options['settings'][$key], $value );
						else
			...
			if ( is_array( $new_options ) ) {
				foreach ( $new_options as $key => $value ) {
					if ( isset( $this->options['sections'][$key] ) )
						...
						// betterbackground['options']=array('color','','','','','');
						if ( $merge == 'replace' || $merge == 'recursive' )
							$this->options['sections'][$key] = array_replace_recursive( $this->options['sections'][$key], $value );
						else
			...
			if ( is_array( $new_options ) ) {
				foreach ( $new_options as $key => $value ) {
					if ( isset( $this->options['panels'][$key] ) )
						...
						// betterbackground['options']=array('color','','','','','');
						if ( $merge == 'replace' || $merge == 'recursive' )
							$this->options['panels'][$key] = array_replace_recursive( $this->options['panels'][$key], $value );
						else
