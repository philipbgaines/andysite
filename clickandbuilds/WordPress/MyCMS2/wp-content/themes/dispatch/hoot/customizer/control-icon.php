	...
	public function render_content() {
		...
		switch ( $this->type ) {
			...
			case 'icon' :
				...
				<div class="hoot-customizer-control-icon-picked hoot-flypanel-button" data-flypaneltype="icon"><i class="fa <?php echo esc_attr( $this->value() ) ?>"></i><span><?php _e( 'Select Icon', 'dispatch' ) ?></span></div>
				<div class="hoot-customizer-control-icon-remove"><i class="fa fa-ban"></i><span><?php _e( 'Remove Icon', 'dispatch' ) ?></span></div>
