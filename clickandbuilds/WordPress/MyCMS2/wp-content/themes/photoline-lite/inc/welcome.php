		...
		<div class="wrap">
			...
			<div class="about-description">
				...
				<?php if ( 'page' == get_option( 'show_on_front' ) && get_option( 'page_on_front' ) ) : ?>
						<p><?php echo sprintf( esc_html__( 'Photoline includes a homepage templates. Assign the homepage templates to your %sfront page%s.', 'photoline-lite' ), '<a href="' . esc_url( get_edit_post_link( get_option( 'page_on_front' ) ) ) . '">', '</a>' ); ?></p>
				<?php endif; ?>
