...
class One_And_One_Wizard {
	...
	public function __construct() {
		...
		add_action( 'plugins_loaded', array( new One_And_One_Tracking(), 'init' ) );
	...
	public function show_welcome_panel() {
		...
		if ( $context ) {
			include( One_And_One_Wizard::get_views_dir_path().'setup-wizard-welcome-panel.php' );
			One_And_One_Setup_Welcome_Panel::render( $context );
		}
	}
